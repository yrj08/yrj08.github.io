  ...
  "24": {title: "Ligne 24 • Sherbrooke", type: "frequent_journee",
    ...
    branchStyles: {
      ...
      "249999": {line: {color: "#8B469E", weight: 4, opacity: 1},
          stop: {radius: 4, weight: 3, color: "#8B469E", fillOpacity: 1, shape: "circle"}},
      "248880": {line: {color: "#781B7D", weight: 4, opacity: 1, dashArray: "5,10"},
          stop: {radius: 4, weight: 3, color: "#781B7D", fillOpacity: 1, shape: "circle"}},
      "249990": {line: {color: "#8B469E", weight: 4, opacity: 1, dashArray: "5,10"},
          stop: {radius: 4, weight: 3, color: "#8B469E", fillOpacity: 1, shape: "circle"}},
      "current": {line: {color: "#FFB350", weight: 10, opacity: 1},
          stop: {radius: 5, weight: 5, color: "#FFB350", fillOpacity: 1, shape: "circle"}}},
    changements: `
  ...
  "28": {title: "Ligne 28 • Honoré-Beaugrand", type: "regulier",
    ...
    branchStyles: {
      ...
      "289999": {line: {color: "#5DBDEA", weight: 4, opacity: 1},
          stop: {radius: 4, weight: 3, color: "#5DBDEA", fillOpacity: 1, shape: "circle"}},
      "288880": {line: {color: "#009EE0", weight: 4, opacity: 1, dashArray: "5,10"},
          stop: {radius: 4, weight: 3, color: "#009EE0", fillOpacity: 1, shape: "circle"}},
      "289990": {line: {color: "#5DBDEA", weight: 4, opacity: 1, dashArray: "5,10"},
          stop: {radius: 4, weight: 3, color: "#5DBDEA", fillOpacity: 1, shape: "circle"}},
      "current": {line: {color: "#FFB350", weight: 10, opacity: 1},
          stop: {radius: 5, weight: 5, color: "#FFB350", fillOpacity: 1, shape: "circle"}}},
    changements: `
  ...
  "33": {title: "Ligne 33 • Langelier", type: "frequent_pointe",
    ...
    branchStyles: {
      ...
      "339999": {line: {color: "#8B469E", weight: 4, opacity: 1},
          stop: {radius: 4, weight: 3, color: "#8B469E", fillOpacity: 1, shape: "circle"}},
      "338880": {line: {color: "#781B7D", weight: 4, opacity: 1, dashArray: "5,10"},
          stop: {radius: 4, weight: 3, color: "#781B7D", fillOpacity: 1, shape: "circle"}},
      "339990": {line: {color: "#8B469E", weight: 4, opacity: 1, dashArray: "5,10"},
          stop: {radius: 4, weight: 3, color: "#8B469E", fillOpacity: 1, shape: "circle"}},
      "current": {line: {color: "#FFB350", weight: 10, opacity: 1},
          stop: {radius: 5, weight: 5, color: "#FFB350", fillOpacity: 1, shape: "circle"}}},
    changements: `
